...
class Gmsscapiv1authService extends __BaseService {
  static readonly authenticatePath = '/gmssc/api/v1/auth/authenticate';
  ...
  authenticateResponse(body?: AuthenticationRequest): __Observable<__StrictHttpResponse<AuthenticationResponse>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gmssc/api/v1/auth/authenticate`,
      __body,
      {
        headers: __headers,
        params: __params,
...
module Gmsscapiv1authService {
}

export { Gmsscapiv1authService }
